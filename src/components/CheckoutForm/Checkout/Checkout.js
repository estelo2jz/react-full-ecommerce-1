...
const Checkout = ({cart, order, onCaptureCheckout, error}) => {
  ...
  useEffect(() => {
    ...
    generateToken();
    // dependency array not empty means is going to run again
  }, [cart]);
  ...
  // if order.custumer exsit only then we wanna show the div, otherwse
  let Confirmation = ()  => order.customer ?  (
    ...
    // show this 
    // this simply means that, while we dont get the order then, were gonna have a spinner, because taking the order take some time
